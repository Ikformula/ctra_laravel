    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-bordered">
            <div class="card-inner">
                <form action="{{ route('frontend.licence.renew.store') }}" method="post" enctype="multipart/form-data">
    @csrf
                ...
                <div class="row gy-4">
                            ...
                            <div class="row gy-2">
                                        ...
                                        <div class="form-control-wrap ">
                                            <div class="form-control-select">
                                                <select class="form-control" id="sticker_type" name="sticker_type">
                                                    <option selected>{{ $vehicle->sticker_type }}</option>
                                                    <option>OC</option>
                                                    <option>SC</option>
                                                    <option>Keke</option>
                                                    <option>DV</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" value="{{ $vehicle->sticker_number }}" class="form-control" id="sticker_number" name="sticker_number">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-3">
                            ...
                            <div class="card card-bordered">
                                <img src="{{ asset('license_reg_files/thumbprints/'.$vehicle->driver()->thumbprint) }}" class="card-img-top" style="max-height: 200px; max-width: 150px;" alt="">
                                <div class="card-inner">
                            ...
                            <div class="row gy-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" value="{{ $vehicle->driver()->nok_phone }}" class="form-control" id="driver_nok_phone" name="driver_nok_phone">
                                        </div>
                                    </div>
                                </div>
